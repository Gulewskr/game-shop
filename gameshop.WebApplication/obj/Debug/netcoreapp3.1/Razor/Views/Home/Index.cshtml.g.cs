#pragma checksum "C:\Studia\PAWiM\GameShop\gameshop.WebApplication\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "a110785555f814c9534f3a1c79a910fee6da5f78"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"a110785555f814c9534f3a1c79a910fee6da5f78", @"/Views/Home/Index.cshtml")]
...
#line 91 "C:\Studia\PAWiM\GameShop\gameshop.WebApplication\Views\Home\Index.cshtml"
                               Write(await Html.PartialAsync("~/Views/Partial/SingleGameBanner.cshtml", games[0], new ViewDataDictionary(ViewData)
                                    {
                                        { "Category", categories.FirstOrDefault(x => x.Id == games[0].CategoryID).Name },
                                        { "Developer", developers.FirstOrDefault(x => x.Id == games[0].DeveloperID).Name },
                                        //{ "Publisher", publishers.FirstOrDefault(x => x.Id == games[0].PublisherID).Name },
